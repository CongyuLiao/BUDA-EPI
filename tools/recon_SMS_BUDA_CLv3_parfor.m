function [img_msl]=recon_SMS_BUDA_CLv3_parfor (kspace_cor_ap, kspace_cor_pa,ky_idx_ap,ky_idx_pa,sens_gre_shift, AccY, AccZ,img_fieldmap,opt)
...
for ii_slc=1:num_slc_raw
    ...
    for iter = 1:num_iter
        ...
        keep = floor(lambda_msl*prod(winSize));
