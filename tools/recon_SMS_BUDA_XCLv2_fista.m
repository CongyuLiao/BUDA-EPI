function [img_msl]=recon_SMS_BUDA_XCLv2_fista (kspace_cor_ap, kspace_cor_pa,ky_idx_ap,ky_idx_pa,sens_gre, AccY, AccZ,img_fieldmap,opt)
...
for ii_slc=1:num_slc_raw
    ...
    for iter = 1:num_iter
        ...
        if (PhaseShiftBase ~=0)
         ...
         mosaic(im_rc_display, AccZ, 2, 71, ['BUDA recon:AP/PA iter-',num2str(iter)], [0,1], 90)
